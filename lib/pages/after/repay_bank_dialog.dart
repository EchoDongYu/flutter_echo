...
/// 认证项选择弹窗
class RepayBankDialog extends StatefulWidget {
  final VoidCallback onClosing;
  final Function(BankDictV0Item?) onConfirm;
  final List<BankDictV0Item> items;
  final BankDictV0Item? pickedItem;
  final String title;

  const RepayBankDialog({
    super.key,
  ...
  /// 显示认证项选择弹窗
  static Future<BankDictV0Item?> show(
    BuildContext context, {
    List<BankDictV0Item>? items,
    BankDictV0Item? pickedItem,
  ...
  @override
  State<RepayBankDialog> createState() => _RepayBankDialogState();
}

class _RepayBankDialogState extends State<RepayBankDialog> {
  BankDictV0Item? _pickedItem;
  ...
  Widget _buildPickItem(BankDictV0Item item) {
